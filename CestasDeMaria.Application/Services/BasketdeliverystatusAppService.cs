...
using IMainRepository = CestasDeMaria.Domain.Interfaces.Repository.IBasketdeliverystatusRepository;
using IMainService = CestasDeMaria.Application.Interfaces.IBasketdeliverystatusAppService;
...
{
    public class BasketdeliverystatusAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public BasketdeliverystatusAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
