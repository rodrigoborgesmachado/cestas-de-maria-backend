...
using IMainService = CestasDeMaria.Application.Interfaces.IFamilyfamilystatushistoryAppService;
...
{
    public class FamilyfamilystatushistoryAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public FamilyfamilystatushistoryAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
