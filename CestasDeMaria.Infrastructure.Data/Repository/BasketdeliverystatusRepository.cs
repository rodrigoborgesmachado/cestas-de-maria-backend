...
{
    public class BasketdeliverystatusRepository : RepositoryBase<Main>, IMainRepository
    {
        public BasketdeliverystatusRepository(CestasDeMariaContext currentContext)
            : base(currentContext)
        {
        }
