...
using IMainAppService = CestasDeMaria.Application.Interfaces.IFamilystatusAppService;
...
namespace CestasDeMaria.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("FamilyStatus")]
    public class FamilystatusController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public FamilystatusController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
