...
using IMainAppService = CestasDeMaria.Application.Interfaces.IBasketdeliverystatusAppService;
...
namespace CestasDeMaria.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("BasketDeliveryStatus")]
    public class BasketdeliverystatusController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public BasketdeliverystatusController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
