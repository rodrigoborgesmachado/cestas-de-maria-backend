...
using IMainAppService = CestasDeMaria.Application.Interfaces.IFamilyfamilystatushistoryAppService;
...
namespace CestasDeMaria.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("FamilyFamilyStatusHistory")]
    public class FamilyfamilystatushistoryController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public FamilyfamilystatushistoryController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
